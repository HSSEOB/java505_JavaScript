...
// 함수와 변후를 모두 가지고 있는 형태의 데이터 타입
// 여기서의 객체 타입은 배열과 같은 형태로 사용하는 객체 타입을 말함
// object 타입이라고 앞으로 언급할것이다.
//배열처럼 하나의 변수명으로 여러개의 데이터를 저장할 수 있는 데이터 타입
// index가 없고, 데이터를 구분하기 위해, key를 사용함
// key와 value의 1:1로 연동되어 있는 형태의 데이터 타입
// 사용 기호는 {}, key와 value는 :으로 구분하고, 각각의 데이터는 ,로 구분한다.
// key 설정 시 문자열로 입력하고,  "",나 ''는 생략해도 무방
// 사용법 : 선언
